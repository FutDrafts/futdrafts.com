    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" size="icon" className="relative" aria-label="Changelog notifications">
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                <ScrollArea className="h-[400px] pr-4">
                    {loading ? (
                        ...
                        <div className="text-muted-foreground py-8 text-center">No changelog entries available</div>
                    )}
                </ScrollArea>
            </DialogContent>
        </Dialog>
